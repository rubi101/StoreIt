...
import { constructDownloadUrl } from '@/src/lib/utils'
import { Input } from './ui/input'
import { Button } from './ui/button'
import { deleteFile, renameFile, updateFileUsers } from '@/src/lib/actions/file.actions'
import { usePathname } from 'next/navigation'
import { FileDetails, ShareFiles } from './ActionsModalContent'
import { FileDoc  , ActionType} from '@/src/types'
    ...
    return (
             <DialogContent className='shad-dialog button'>
              <DialogHeader className='flex flex-col gap-3'>
                ...
                {value === "share" && <ShareFiles file = {file}
                  onInputChange= {setEmails} onRemove = {handleRemoveUser}/>
                }
              ...
              {["rename","delete","share"].includes(value) && (<DialogFooter className='flex flex-col gap-4 md:flex-row'>
